def caesar_cipher_decrypt(ciphertext, shift):
    ...
    for char in ciphertext:
        if char.isalpha():
            shift_amount = 26 - shift  # Shifting backward
            if char.isupper():
